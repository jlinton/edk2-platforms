...
4. Create a `config.txt` with the following content:
    ...
    device_tree_address=0x2f0000
    device_tree_end=0x300000
    ```
...
Note: the address range **must** be `[0x2f0000:0x300000]`. `dtoverlay` and `dtparam` parameters are also supported.
