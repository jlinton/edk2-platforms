...
!endif
  ...
  PlatformFlashAccessLib|Silicon/Broadcom/Library/PlatformFlashAccessLib/PlatformFlashAccessLib.inf
...
[PcdsFixedAtBuild.common]
  ...
  # 0x002F0000 - 0x00300000 DTB (PcdFdtBaseAddress, PcdFdtSize)
  # 0x00300000 - ...        RAM (PcdSystemMemoryBase, PcdSystemMemorySize)
  #
  # This matches PcdFvBaseAddress, since everything less is the FD, and
  # will be reserved away.
  #
  gArmTokenSpaceGuid.PcdSystemMemoryBase|0x00300000
...
!include NetworkPkg/Network.dsc.inc
  ...
  # Firmware update
  #
  Platform/RaspberryPi/Drivers/SystemFirmwareDescriptor/SystemFirmwareDescriptor.inf
