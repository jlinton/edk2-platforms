...
//extern void *mRpiImageDescriptor;
#include "SystemFirmwareDescriptorTable.aslc"
...
*/
  ...
  // solve the problem with the linker?
  Descriptor = (EDKII_SYSTEM_FIRMWARE_IMAGE_DESCRIPTOR  *) &mRpiImageDescriptor.Descriptor;
